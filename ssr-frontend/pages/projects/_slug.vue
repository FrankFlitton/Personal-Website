        ...
        <v-col md="3" offset-md="1" cols="12" fill-height class="p-relative">
          <v-row style="position: sticky; top: 0;" class="pt-15">
            ...
            <v-col cols="6" md="12" class="pb-md-0">
              ...
              <p>
                <a :href="page.clientUrl" target="_blank" class="text-decoration-none grey--text">
                  {{ page.client }}
                </a>
              </p>
            ...
            <v-col cols="6" md="12" class="py-md-0">
              ...
              <p>
                <a :href="page.projectUrl" target="_blank" class="text-decoration-none grey--text">
                  See More
                </a>
              </p>
            </v-col>
